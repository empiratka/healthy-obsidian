...
- [[behavior_intermittent_fasting|Intermittent fasting]] (IF) is associated with:
    ...
    - [[favorable changes in leptin and adiponectin levels]]
...
- Evidence is especially insufficient for:
    - individuals with metabolic syndrome (MetS)
    - prediabetes
    - T2DM
- Long-term follow-up data are limited, making it difficult to:
    - assess sustainability
    - evaluate IF as a permanent lifestyle approach
    - determine the risk–benefit ratio of different IF protocols
